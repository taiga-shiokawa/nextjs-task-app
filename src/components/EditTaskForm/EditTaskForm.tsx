    ...
    return (
        <div className="mt-10 mx-auto w-full max-w-sm">
            <form action={formAction}>
                ...
                <div className="mt-6">
                    <label htmlFor="dueDate" className="block text-sm font-medium">DueDate</label>
                    <input type="date" id="dueDate" name="dueDate" value={dueDate} onChange={(e) => setDueDate(e.target.value)} min="2020-01-01" max="2999-12-31" required className="block mt-2 py-1.5 px-2 w-full rounded-md border-0 shadow-sm ring-1 ring-inset ring-gray-300"/>
                </div>
                <div className="mt-6 flex items-center">
                    ...
                    <label htmlFor="isCompleted" className="text-sm">Complete the task</label>
                </div>
                <SubmitButton />
                { state.error !== "" && (
